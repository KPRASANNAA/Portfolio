  ...
  return (
    <div className="w-[320px] h-[420px] perspective">
      <div className="relative w-full h-full transition-transform duration-700 transform-style preserve-3d hover:rotate-y-180">
        ...
        <div className="absolute inset-0 bg-[#0b1220] border border-gray-700 rounded-2xl overflow-hidden backface-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 to-black border border-blue-500 rounded-2xl p-8 rotate-y-180 backface-hidden">
